...
public class PrisonerProfile extends Application {
    ...
    private Button btnGoBack, btnChooseP, btnFindProfile;
    ...
    public void start(Stage primaryStage){
        ...
        lblPrsProfile = new Label("View Profile");
        ...
        btnChooseP.setOnAction(event -> {
            ...
            photoFile = photoFile1.showOpenDialog(ProfileStage);
            if(photoFile != null){
        ...
        ProfilePane.getChildren().addAll(lblPrsProfile, lblPrsID, txfPrsId, btnFindProfile, lblFName, lblMidName, lblLName,
                ...
                rbtO,txfBlood,taCrime,taHealth,ImgRect,ImgView,btnChooseP,taEmegency,txfCellNo, btnGoBack);

        Scene UpdateScene = new Scene(ProfilePane, 800, 600);

        ProfileStage.setTitle("Prisoner Profile");
        ProfileStage.setResizable(false);
        ProfileStage.setScene(UpdateScene);
        ProfileStage.show();
    }
    public void ViewProfile( int PID){
